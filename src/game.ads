...
package Game is
    ...
    function DiscoverFreeZone(DiscoverBoard, UserBoard, RealBoard, MineBoard : Array2D; Pos_x, Pos_y : Integer) return Array2D;
    function mergeDiscoverBoard(DiscoverBoard_1, DiscoverBoard_2 : Array2D) return Array2D;
